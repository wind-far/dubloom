...
const messages: Record<UiLanguage, Messages> = {
  en: {
    ...
    home: {
      ...
      reviewModeLabel: "Translation review",
      reviewRequired: "Pause for review (recommended)",
      reviewNone: "Skip review",
      translationProfile: "Translation profile",
      ttsProfile: "Voice profile",
    ...
    task: {
      ...
      reviewWorkspace: "Open review workspace",
      awaitingReviewHelp: "Translation is ready. Review each segment before rendering continues.",
      staleResultTitle: "Final video is out of date",
      staleResultHelp: "One or more reviewed segments changed after the last render.",
      renderDirty: "Apply all changes",
      renderingDirty: "Submitting changes",
      renderDirtyError: "Failed to render changed segments",
    },
    review: {
      ...
      loadError: "Failed to load review segments",
      sourceText: "Source",
      ...
      speaker: "Speaker",
      audioMode: "Audio",
      audioTts: "Generated voice",
      audioOriginal: "Original audio",
      ttsProfile: "Voice profile",
      defaultProfile: "Task default",
      save: "Save",
      saving: "Saving",
      saved: "Saved",
      saveError: "Failed to save segment",
      conflict: "This segment changed elsewhere. Reload it before saving again.",
      sourceAudio: "Source audio",
      previewAudio: "Voice preview",
      generatePreview: "Generate preview",
      generatingPreview: "Generating preview",
      previewError: "Failed to generate preview",
      emptyTranslation: "Translation cannot be empty.",
      invalidStart: "Start time must be zero or greater.",
      invalidEnd: "End time must be later than start time.",
      highReadingSpeed: "Reading speed is high; consider shortening the translation.",
      shortReference: "The source reference is short and voice consistency may suffer.",
      dirty: "Changed",
      warning: "Warning",
      approve: "Approve and continue",
      approving: "Approving",
      approveError: "Failed to approve review",
      fixErrors: "Fix hard validation errors before continuing.",
      renderDirty: "Apply all changes",
      renderingDirty: "Submitting changes",
      renderDirtyError: "Failed to render changed segments",
      noSegments: "No reviewable segments are available yet.",
      refresh: "Refresh",
      resultStale: "The rendered result is out of date.",
  ...
  zh: {
    ...
    home: {
      ...
      outputBoth: "硬字幕和配音",
      reviewModeLabel: "翻译校审",
      reviewRequired: "翻译后暂停校审（推荐）",
      reviewNone: "跳过人工校审",
    ...
    task: {
      ...
      reviewWorkspace: "进入校审工作台",
      awaitingReviewHelp: "翻译已经完成，请逐句校审后再继续生成。",
      staleResultTitle: "当前成片已过期",
      staleResultHelp: "上次生成后有字幕段发生修改，请应用全部更改。",
      renderDirty: "应用全部更改",
      renderingDirty: "正在提交更改",
      renderDirtyError: "提交脏段渲染失败",
    },
    review: {
      title: "逐句校审工作台",
      sourceVideo: "原视频预览",
      ...
      audioOriginal: "保留原音",
      ttsProfile: "声音配置",
      defaultProfile: "沿用任务默认",
      save: "保存",
      saving: "保存中",
      saved: "已保存",
      saveError: "保存字幕段失败",
      conflict: "该字幕段已在别处更新，请刷新后再保存。",
      sourceAudio: "原始人声",
      previewAudio: "配音预览",
      generatePreview: "生成预览",
      generatingPreview: "正在生成预览",
      previewError: "生成预览失败",
      emptyTranslation: "译文不能为空。",
      invalidStart: "开始时间必须大于等于 0。",
      invalidEnd: "结束时间必须晚于开始时间。",
      highReadingSpeed: "译文语速偏快，建议精简。",
      shortReference: "原声参考时间较短，音色一致性可能下降。",
      dirty: "已修改",
      warning: "提醒",
      approve: "批准并继续生成",
      approving: "正在批准",
