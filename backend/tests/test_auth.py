...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("GET", "/api/tasks/missing/segments"),
        ("PATCH", "/api/tasks/missing/segments/missing"),
        ("POST", "/api/tasks/missing/segments/missing/preview"),
        ("GET", "/api/tasks/missing/segments/missing/audio"),
        ("POST", "/api/tasks/missing/review/approve"),
        ("POST", "/api/tasks/missing/render-dirty"),
        ("GET", "/api/tasks/missing/artifact/source-video"),
        ...
        ("GET", "/api/provider-profiles/missing"),
        ("PATCH", "/api/provider-profiles/missing"),
        ("DELETE", "/api/provider-profiles/missing"),
